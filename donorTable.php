					...
					<tbody>
						...
						while($data=$plist->fetch_assoc()){
							...
							<tr>
								...
								<th><CENTER><i class="fas fa-eye view-details" data-toggle="modal" data-target="#modal<?php echo $data['donorid'];?>" style="cursor: pointer;transition: 0.5s;"></i></CENTER></th>

								
								
								<td><a href="editdonor.php?id=<?php echo $data['donorid'];?>"><i class="fas fa-edit"></i></a> / <a href="dashboard.php?id=<?php echo $data['donorid'];?>&pg=<?php echo $page; ?>" style="color:#EB0206;"><i class="fas fa-trash-alt"></i></a></td>
							</tr>
							<!-- Modal -->

							<div class="modal fade bd-example-modal-sm" id="modal<?php echo $data['donorid'];?>" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="donor-profile">
												<div class="donor-img">
													<img  src="donorimg/<?php echo $data['image']; ?>" >
												</div>
												<center>
